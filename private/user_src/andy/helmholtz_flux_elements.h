...
private:
 ...
 /// Jacobian as well. 
 void fill_in_generic_residual_contribution_helmholtz_flux(
...
{
 //Check
 oomph_info << "Inside HelmholtzFluxElement::fill_in_generic_residual"
            << "_contribution_helmholtz_flux(...)" << std::endl;
 ...
 const unsigned u_index_helmholtz = U_index_helmholtz;
 ...
 for(unsigned ipt=0;ipt<n_intpt;ipt++)
  {
   ...
   for(unsigned l=0;l<n_node;l++)
    {
     local_eqn = nodal_local_eqn(l,u_index_helmholtz);
     ...
     if(local_eqn >= 0)
      {
       ...
       //Does this need an interpolated_u adding as well?
