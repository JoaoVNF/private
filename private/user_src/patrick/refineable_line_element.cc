...
namespace oomph
{
 ...
 ///     history.
 ///   - PATRICKFLAG: Determine the boundary conditions of the nodes (newly created nodes
 ///     can only lie on the interior of any 
  ...
  if(node_pt(0)==0)
   {
    ...
    // PATRICKFLAG NOT SURE ABOUT THIS!
      ...
      for(unsigned n=0;n<n_node;n++)
       {
        ...
        // PATRICKFLAG: This is commented in RefineableQElement<2> also
        ...
        if(created_node_pt!=0)
         {
          ...
          // PATRICKFLAG: DO I NEED THIS THEN?
        ...
        // ------------------------------------------
        ...
        else
         {
          ...
          // position.
          bool is_periodic = false; // PATRICKFLAG: SEEMS FISHY...
        ...
        if(!node_done)
         {
          ...
          // PATRICKFLAG: I HAVE PUT ALL OF THE FOLLOWING IN A SINGLE LOOP RATHER THAN TWO SEPERATE LOOPS AS THERE WAS BEFORE -- WILL THIS BE A PROBLEM? I DON'T THINK SO....
          ...
          for(unsigned t=0;t<ntstorage;t++)
           {
            ...
            // Loop over all values and assign set the previous values
 ...
 void RefineableQElement<1>::output_corners(
  std::ostream& outfile,const std::string& colour="BLACK") const // PATRICKFLAG: THIS FUNCTION NEEDS LOOKING AT!!
 {
  ...
  outfile << "ZONE I=2,J=2, C=" << colour << std::endl; // PATRICKFLAG - WHAT DOES THIS MEAN?
 ...
 //==========================================================================
 //template<unsigned NNODE_1D> // PATRICKFLAG: WHAT IS THIS? IS COMMENTED IN RefineableQElement<2> also!
