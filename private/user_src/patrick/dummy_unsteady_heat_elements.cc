...
#include "dummy_unsteady_heat_elements.h"
...
const unsigned DummyQUnsteadyHeatElement<DIM,NNODE_1D>::Initial_Nvalue = 1;
...
void  DummyUnsteadyHeatEquations<DIM>::
 ...
 for(unsigned ipt=0;ipt<n_intpt;ipt++)
  {
   ...
   //-------------------
   double coefficient;
   get_coefficient_ust_heat(time(),ipt,interpolated_x,coefficient);
     ...
     if(local_eqn >= 0)
      {
       ...
       // Add body force/coefficient term and time derivative
       residuals[local_eqn] += (dudt-(coefficient*interpolated_u))*test(l)*W;
...
//======================================================================
template <unsigned DIM>
unsigned  DummyUnsteadyHeatEquations<DIM>::self_test() 
{
...
//======================================================================
template <unsigned DIM>
void  DummyUnsteadyHeatEquations<DIM>::output(std::ostream &outfile, 
...
//======================================================================
template <unsigned DIM>
void  DummyUnsteadyHeatEquations<DIM>::output(FILE* file_pt,
                                         const unsigned &nplot)
{
 //Vector of local coordinates
 Vector<double> s(DIM);
...
//======================================================================
template <unsigned DIM>
void DummyUnsteadyHeatEquations<DIM>::output_fct(std::ostream &outfile, 
                                            const unsigned &nplot, 
...
//======================================================================
template <unsigned DIM>
void DummyUnsteadyHeatEquations<DIM>::compute_error(std::ostream &outfile, 
                                           FiniteElement::SteadyExactSolutionFctPt exact_soln_pt,
...
//====================================================================
template class DummyQUnsteadyHeatElement<1,2>;
template class DummyQUnsteadyHeatElement<1,3>;
template class DummyQUnsteadyHeatElement<1,4>;

template class DummyQUnsteadyHeatElement<2,2>;
template class DummyQUnsteadyHeatElement<2,3>;
template class DummyQUnsteadyHeatElement<2,4>;

template class DummyQUnsteadyHeatElement<3,2>;
template class DummyQUnsteadyHeatElement<3,3>;
template class DummyQUnsteadyHeatElement<3,4>;
