...
//LIC// 
//LIC//====================================================================
//Header file for my FoepplvonKarman elements
#ifndef OOMPH_MY_FOEPPLVONKARMAN_ELEMENTS_HEADER
#define OOMPH_MY_FOEPPLVONKARMAN_ELEMENTS_HEADER
...
public:
 ...
 /// \short Function pointer to pressure function fct(x,w,f(x,w)) --
 /// x is a Vector!
 ...
 /// \short Function pointer to pressure function fct(x,w,f(x,w)) --
 /// x is a Vector!
 typedef void (*FoepplvonKarmanAiryForcingFctPt)(
   const Vector<double>& x,
   double& f);
 ...
 FoepplvonKarmanEquations() : Pressure_fct_pt(0),
  Airy_forcing_fct_pt(0), Pre_stress_fct_pt(0)
  {
 ...
 FoepplvonKarmanAiryForcingFctPt& airy_forcing_fct_pt()
