...
/*  void output(FILE* file_pt, const unsigned &n_plot); */
 ...
 /// \short Static flag that determines output format: Just meniscus
 /// (true) or the lot
 static bool Output_meniscus_and_spines;

 /// Helper fct: Allocate storage for a vector of vectors of doubles to 
 ...
 {
  unsigned n=v1.size();
  for (unsigned i=0; i<n; i++) vs[i]=v1[i]+v2[i];
 }
...
/*  ///  x,y,u   or    x,y,z,u */
/*  void output(FILE* file_pt) */
/*   {YoungLaplaceEquations::output(file_pt);} */


/*  ///  \short C-style output function:   */
/*  ///   x,y,u   or    x,y,z,u at n_plot^2 plot points */
/*  void output(FILE* file_pt, const unsigned &n_plot) */
/*   {YoungLaplaceEquations::output(file_pt,n_plot);} */
